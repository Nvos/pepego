import {TodosComponent, TodosTodos, TodosVariables, UsersComponent, UsersUsers, UsersVariables} from "@libs/models";
...
const Test = () => (<Composed>
  {({users, todos}) => <div>
    // Render prop variant of multiple graphql render props
  </div>}
</Composed>)